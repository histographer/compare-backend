...
public class CompareImageTest {
    ...
    public void testCompareImages() throws Exception {
        PostMethodWebRequest request = createPostRequestWithMessageBody("scoring",
                "{\"projectId\": 20, \"chosen\": {\"id\": 1, \"comment\": "
                        + "\"a comment\"}, \"other\": {\"id\": 2}}",
                "application/json");
    ...
    public void testStatusCode400(String messageBody, String failureMessage) throws Exception {
        ...
        HttpURLConnection connection = (HttpURLConnection) new URL(baseUrl, "scoring")
                .openConnection();
        connection.setDoOutput(true);
        connection.setRequestProperty(
                "Cookie",
                "JSESSIONID=" + conversation.getCookieValue("JSESSIONID")
        );
    ...
    private String[][] getStatusCodeParameters() {
        return new String[][] {
                ...
                {"{\"chosen\": {\"id\": 1}, \"other\": {\"id\": 2}}",
                    "Testing lack of project ID"
                },
                {"{\"projectId\": 20, \"other\": {\"id\": 2}}", "Testing lack of chosen image"},
                {"{\"projectId\": 20, \"chosen\": {\"id\": 2}}", "Testing lack of other image"},
                {"{\"projectId\": 20, \"chosen\": {}, \"other\": {\"id\": 2}}",
                    "Testing lack of chosen image ID"
                },
                {"{\"projectId\": \"abc\", \"chosen\": {\"id\": 1}, \"other\": {\"id\": 2}}",
                    "Testing invalid type for project ID"
                },
                {"{\"projectId\": 20, \"chosen\": {\"id\": \"abc\"}, \"other\": {\"id\": 2}}",
                    "Testing invalid type for chosen ID"
                }
        };
    }
    ...
    public void testUnicodeCharactersOnCreation() throws Exception {
        ...
        WebRequest request = createPostRequestWithMessageBody("scoring",
