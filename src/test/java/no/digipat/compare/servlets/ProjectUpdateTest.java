...
public class ProjectUpdateTest {
    ...
    public void testUpdateProjectStatus(boolean active) throws Exception {
        ...
        WebRequest request = createPostRequestWithMessageBody("project/update", requestJson.toString(), "application/json");
    ...
    public void testStatusCode404() throws Exception {
        ...
        WebRequest request = createPostRequestWithMessageBody("project/update", json.toString(), "application/json");
    ...
    public void testStatusCode400(String messageBody, String failureMessage) throws Exception {
        WebConversation conversation = new WebConversation();
        WebRequest request = createPostRequestWithMessageBody("project/update", messageBody, "application/json");
    ...
    private String[][] getStatusCode400Parameters() {
        return new String[][] {
            ...
            {"{\"projectId\": \"abc\", \"active\": true}", "Testing with non-numeric project ID."},
            {"{\"projectId\": 42, \"active\": \"blah\"}", "Testing with non-boolean active parameter."}
        };
    }
